<<<<<<< HEAD:CDAutomation/src/elements/IOSDrivers.java
package elements;
...
public class IOSDrivers {
	...
	public static void setUp() throws Exception {
		System.out.println("IOS DRIVERS");
	...
	public static IOSDriver<WebElement> callDriver() {
		return driver;
	}
...
/// Common elements ///
	...
	public WebElement back_button() {
	    return wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//UIAApplication[1]/UIAWindow[1]/UIANavigationBar[1]/UIAButton[1]")));
	}
	...
	public WebElement dont_allow() {
	    return wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//UIAApplication[1]/UIAWindow[7]/UIAAlert[1]/UIACollectionView[1]/UIACollectionCell[1]/UIAButton[1]")));
	}
...
/// Home page elements /// 	
	...
	public WebElement login_username() {
	    return wait.until(ExpectedConditions.elementToBeClickable(By.id("testacct01")));
	}
	...
	public WebElement group_three_dotted_menu() {
		return wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//UIAApplication[1]/UIAWindow[1]/UIANavigationBar[1]/UIAButton[4]")));
	}
	...
	public WebElement dusting_with() {
		return wait.until(ExpectedConditions.elementToBeClickable(By.name("99_reveal_info_arrow_red_btn")));
	}
	...
	public WebElement more_button() {
	    return wait.until(ExpectedConditions.elementToBeClickable(By.name("profileMore")));
	}
...
/// More page elements ///
    ...
    public WebElement logout() {
        return wait.until(ExpectedConditions.elementToBeClickable(By.name("Log Out")));
    }
    ...
    public WebElement confirm_delete_account() {
...
/// Sign up elements ///
    ...
    public IOSElement pick_username() {
        return (IOSElement) wait.until(ExpectedConditions.elementToBeClickable(By.id("  pick a unique username")));
    }
    public IOSElement create_password() {
        return (IOSElement) wait.until(ExpectedConditions.elementToBeClickable(By.id("  create a password")));
    }
    public IOSElement confirm_password() {
        return (IOSElement) wait.until(ExpectedConditions.elementToBeClickable(By.id("  confirm password")));
    }
    ...
    public IOSElement date_year() {
        return (IOSElement) wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//UIAApplication[1]/UIAWindow[1]/UIAPicker[1]/UIAPickerWheel[3]")));
    }
...
>>>>>>> BrantK/master:CDAutomation/src/elements/IOSElements.java
